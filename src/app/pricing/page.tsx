  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        t("features.basicSimulation"),
        t("features.basicPredictive"),
        t("features.basicDataLineage"),
    ...
    },
    {
      ...
      features: [
        ...
        t("features.unlimitedSimulation"),
        t("features.advancedPredictive"),
        t("features.fullDataLineage"),
        t("features.aiSegmentation"),
